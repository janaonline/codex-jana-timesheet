...
export const EMAIL_TEMPLATE_DEFINITIONS = {
  REMINDER_25TH: {
    label: "Draft reminder 1",
    description: "Reminder to keep the active payroll-period timesheet moving.",
    sampleTokens: {
      userName: "Anita Director",
      monthLabel: "March 2026 (20 Feb - 19 Mar)",
      completionPercentage: "58",
      remainingHours: "68",
      deadlineDate: "19/03/2026",
      autoSubmitDate: "25/03/2026",
  ...
  REMINDER_28TH: {
    label: "Draft reminder 2",
    description: "Reminder to continue filling the active payroll-period timesheet.",
    sampleTokens: {
      userName: "Anita Director",
      monthLabel: "March 2026 (20 Feb - 19 Mar)",
  ...
  REMINDER_LAST_DAY: {
    ...
    description: "Reminder to submit or complete the active payroll-period timesheet.",
    sampleTokens: {
      userName: "Anita Director",
      monthLabel: "March 2026 (20 Feb - 19 Mar)",
  ...
  REMINDER_3RD: {
    label: "Pending-period reminder",
    description: "Reminder about the labelled period before the fixed 25th-day cutoff.",
    sampleTokens: {
      userName: "Anita Director",
      monthLabel: "February 2026 (20 Jan - 19 Feb)",
      completionPercentage: "96",
      remainingHours: "6",
      deadlineDate: "19/02/2026",
      autoSubmitDate: "25/02/2026",
      submitUrl: "http://localhost:3000/timesheets/sample",
      requestEditUrl: "http://localhost:3000/timesheets/sample",
      supportContactEmail: "support@janaagraha.org",
      appName: APP_NAME,
  ...
  FINAL_NOTICE_SUCCESS: {
    ...
    description: "Sent on the fixed 25th-day cutoff when auto-submit succeeds.",
    sampleTokens: {
      userName: "Anita Director",
      monthLabel: "February 2026 (20 Jan - 19 Feb)",
  ...
  FINAL_NOTICE_FAILURE: {
    ...
    description: "Sent on the fixed 25th-day cutoff when a labelled period remains incomplete.",
    sampleTokens: {
      userName: "Anita Director",
      monthLabel: "February 2026 (20 Jan - 19 Feb)",
...
export const DEFAULT_EMAIL_TEMPLATE_CONTENT: Record<EmailTemplateKey, EmailTemplateContent> = {
  ...
  REMINDER_28TH: {
    ...
    html: buildReminderBody("A quick check-in before period end"),
    text:
  ...
  REMINDER_LAST_DAY: {
    ...
    html: buildReminderBody("Today is the period-end day to review your draft"),
    text:
      "Hello {{userName}}, today is the period-end day to complete your {{monthLabel}} timesheet. Completion: {{completionPercentage}}%. Remaining hours: {{remainingHours}}. Deadline: {{deadlineDate}}. Open it here: {{submitUrl}}. Support: {{supportContactEmail}}.",
  },
  REMINDER_3RD: {
    subject: "Reminder: your {{monthLabel}} timesheet is still pending",
    html: buildReminderBody("The fixed 25th-day cutoff is approaching"),
    text:
